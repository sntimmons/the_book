...
import { ComingSoonInterest } from './ComingSoonInterest'
...
// Shared scaffold for every "coming soon" preview/explainer screen: back bar,
// hero icon, coming-soon tag, vision lede, a few piece cards, then the interest
// signal. Each screen is a thin wrapper that supplies its own copy + featureName.
      ...
      >
        <View style={styles.hero}>
          <View style={styles.heroIcon}>
            <Ionicons name={heroIcon} size={28} color="#F0E8D5" />
          </View>
        ...
        <View style={styles.footer}>
          ...
          <ComingSoonInterest featureName={featureName} />
        </View>
      </ScrollView>
    </View>
  )
