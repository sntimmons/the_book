...
| [operations/DISCOVERY_OPERATIONS.md](operations/DISCOVERY_OPERATIONS.md) | Operations | **Authoritative** - the discovery lanes and the fairness rules behind them (PD-114 … PD-117). Had no index row until 2026-09-14. |
| [operations/BOOKING_INTEGRITY_OPERATIONS.md](operations/BOOKING_INTEGRITY_OPERATIONS.md) | Operations | **Authoritative** - booking write-integrity, expiry and the draft model, as operated. Had no index row until 2026-09-14. |
| [operations/UX_OPERATIONS.md](operations/UX_OPERATIONS.md) | Operations | **Authoritative** - the cross-app UX corrections and the claims guards that hold them. Had no index row until 2026-09-14. |
