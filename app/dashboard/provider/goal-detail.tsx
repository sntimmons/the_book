        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.pad}>
          ...
          <View style={s.card}>
            ...
            <View style={s.quadRow}>
              ...
              <View style={s.quad}>
                <Text style={s.quadValue}>{perWeek} more</Text>
...
const s = StyleSheet.create({
  ...
  editLink: { fontSize: 14, color: '#C8922A', fontFamily: 'Manrope_600SemiBold', width: 40, textAlign: 'right' },
  ...
  monthLabel: { fontSize: 14, color: '#F0E8D5', fontFamily: 'Manrope_600SemiBold' },
  bigValue: { fontSize: 30, color: '#F0E8D5', fontFamily: 'Manrope_700Bold', letterSpacing: -0.5 },
  bigValueSub: { fontSize: 15, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular' },
  progressTrack: {
    height: 10,
    borderRadius: 5,
  ...
  quadRow: { flexDirection: 'row', marginTop: 14, gap: 16 },
  quad: { flex: 1 },
  quadValue: { fontSize: 18, color: '#F0E8D5', fontFamily: 'Manrope_700Bold' },
  quadLabel: { fontSize: 12, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular', marginTop: 2 },
  cardTitle: { fontSize: 15, color: '#F0E8D5', fontFamily: 'Manrope_600SemiBold', marginBottom: 12 },
  actionRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  actionText: { flex: 1, fontSize: 13, color: 'rgba(240,232,213,0.9)', fontFamily: 'Manrope_400Regular' },
  actionValue: { fontSize: 13, color: '#4CAF50', fontFamily: 'Manrope_600SemiBold' },
  sectionLabel: {
    fontSize: 10,
    color: 'rgba(240,232,213,0.45)',
