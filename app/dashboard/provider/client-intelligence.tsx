...
const s = StyleSheet.create({
  ...
  overdueText: { fontSize: 11, color: '#C8922A', fontFamily: 'Manrope_500Medium' },
  remindBtn: {
  ...
  remindText: { fontSize: 12, color: '#080808', fontFamily: 'Manrope_600SemiBold' },
  tableRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 12 },
  ...
  avatarSmText: { fontSize: 11, color: '#F0E8D5', fontFamily: 'Manrope_600SemiBold' },
  visitsCol: { alignItems: 'center', gap: 3, width: 56 },
  visitsValue: { fontSize: 14, color: '#F0E8D5', fontFamily: 'Manrope_600SemiBold' },
  statusPill: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
  statusText: { fontSize: 9, fontFamily: 'Manrope_600SemiBold' },
  ltv: { fontSize: 14, color: '#F0E8D5', fontFamily: 'Manrope_700Bold', width: 60, textAlign: 'right' },
