        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.pad}>
          ...
          <View style={s.card}>
            ...
            <View style={s.legendRow}>
              ...
              {CELL_COLORS.map((c, i) => (
                <View key={i} style={[s.legendCell, i === 0 && s.legendCellEmpty, { backgroundColor: c }]} />
              ))}
...
const s = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, lineHeight: 30, color: '#F0E8D5', fontFamily: 'Manrope_700Bold' },
  ...
  statTriple: { flexDirection: 'row', gap: 10, marginBottom: 16 },
  statBox: {
    flex: 1,
  ...
  statValue: { fontSize: 20, lineHeight: 20, color: '#F0E8D5', fontFamily: 'Manrope_700Bold' },
  statLabel: {
    fontSize: 11,
    lineHeight: 16.5,
    color: 'rgba(240,232,213,0.45)',
  ...
  heatHeaderRow: { flexDirection: 'row', marginBottom: 8 },
  ...
  heatCellEmpty: { borderWidth: 1, borderColor: 'rgba(240,232,213,0.06)' },
  heatClosed: { fontSize: 11, lineHeight: 16.5, color: 'rgba(240,232,213,0.45)' },
  legendRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', gap: 6, marginTop: 21 },
  legendText: { fontSize: 10, lineHeight: 15, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular' },
  legendCell: { width: 12, height: 12, borderRadius: 2 },
  legendCellEmpty: { borderWidth: 1, borderColor: 'rgba(240,232,213,0.06)' },
  ...
  slotRank: { fontSize: 15, lineHeight: 22.5, color: '#C8922A', fontFamily: 'Manrope_700Bold', width: 28 },
  flex1: { flex: 1 },
  slotLabel: { fontSize: 15, lineHeight: 22.5, color: '#F0E8D5', fontFamily: 'Manrope_600SemiBold' },
  slotMeta: { fontSize: 13, lineHeight: 19.5, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular', marginTop: 2 },
  slotPct: { fontSize: 15, lineHeight: 22.5, color: '#4CAF50', fontFamily: 'Manrope_700Bold' },
  rowBetween: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  problemLabel: { fontSize: 15, lineHeight: 22.5, color: '#F0E8D5', fontFamily: 'Manrope_600SemiBold' },
  problemRate: { fontSize: 14, lineHeight: 21, color: '#E05C5C', fontFamily: 'Manrope_700Bold' },
  problemNote: {
    fontSize: 13,
  ...
  capPct: { fontSize: 28, lineHeight: 42, color: '#F0E8D5', fontFamily: 'Manrope_700Bold' },
  capPctSub: { fontSize: 14, lineHeight: 21, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular' },
  progressTrack: {
    height: 10,
    borderRadius: 9999,
  ...
  progressFill: { height: 10, borderRadius: 9999, backgroundColor: '#C8922A' },
  capRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 },
  capLabel: { fontSize: 14, lineHeight: 21, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular' },
  capValue: { fontSize: 14, lineHeight: 21, color: '#F0E8D5', fontFamily: 'Manrope_400Regular' },
  barRow: { marginBottom: 14 },
  barTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 },
  barLabel: { fontSize: 15, lineHeight: 22.5, color: '#F0E8D5', fontFamily: 'Manrope_600SemiBold' },
  dayMeta: { fontSize: 12, lineHeight: 18, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular', marginTop: 2 },
  barAmount: { fontSize: 15, lineHeight: 22.5, color: '#F0E8D5', fontFamily: 'Manrope_700Bold' },
  barTrack: { height: 4, borderRadius: 9999, backgroundColor: 'rgba(240,232,213,0.05)', overflow: 'hidden' },
  barFill: { height: 4, borderRadius: 9999, backgroundColor: '#C8922A' },
})
