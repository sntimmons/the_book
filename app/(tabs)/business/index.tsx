...
const QUICK_ACTIONS = [
  { icon: 'plus-circle', label: 'Add Service', route: '/(tabs)/business/services' },
  { icon: 'clock', label: 'Set Hours', route: '/(tabs)/business/availability' },
  { icon: 'image', label: 'Add Photos', route: '/(tabs)/business/portfolio' },
  { icon: 'file-text', label: 'Contracts', route: '/(tabs)/business/contracts-list' },
      ...
      >
        ...
        {hasAvailability === false && !availNudgeDismissed && (
          <TouchableOpacity
            ...
            activeOpacity={0.85}
            onPress={() => router.push('/(tabs)/business/availability' as any)}
          >
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity
              activeOpacity={0.7}
              onPress={() => router.push('/(tabs)/business/bookings' as never)}
            >
