...
const s = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, color: '#F0E8D5', fontFamily: 'Manrope_700Bold', letterSpacing: -0.45, lineHeight: 28 },
  ...
  statValue: { fontSize: 20, color: '#F0E8D5', fontFamily: 'Manrope_700Bold', textAlign: 'center', lineHeight: 28 },
  sectionTitle: {
    fontSize: 14,
    color: 'rgba(240,232,213,0.45)',
    fontFamily: 'Manrope_700Bold',
  ...
  rank: { fontSize: 16, color: '#C8922A', fontFamily: 'Manrope_700Bold', lineHeight: 24, width: 16 },
  svcName: { fontSize: 13, color: '#F0E8D5', fontFamily: 'Manrope_700Bold', lineHeight: 19.5 },
  svcMeta: { fontSize: 11, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular', lineHeight: 16.5, marginTop: 2 },
  perHr: { fontSize: 14, color: '#F0E8D5', fontFamily: 'Manrope_700Bold', lineHeight: 20 },
  ...
  barTrack: { height: 6, borderRadius: 9999, backgroundColor: 'rgba(255,255,255,0.05)', overflow: 'hidden' },
  barFill: { height: 6, borderRadius: 9999, backgroundColor: '#C8922A' },
  barFillRed: { height: 6, borderRadius: 9999, backgroundColor: '#E05C5C' },
  tipRow: { flexDirection: 'row', gap: 12, alignItems: 'flex-start' },
  flex1: { flex: 1 },
  tipTitle: { fontSize: 14, color: '#F0E8D5', fontFamily: 'Manrope_700Bold', lineHeight: 20, marginBottom: 4 },
  tipText: { fontSize: 12, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular', lineHeight: 19.5 },
  problemNote: {
    fontSize: 11,
    color: 'rgba(240,232,213,0.45)',
    fontFamily: 'Manrope_400Regular',
  ...
  slotTime: { fontSize: 10, color: '#C8922A', fontFamily: 'Manrope_700Bold', textAlign: 'center', lineHeight: 15, marginTop: 8 },
})
