...
const s = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, lineHeight: 20, color: '#F0E8D5', fontFamily: 'Manrope_700Bold', letterSpacing: 0.1 },
  ...
  riskCard: { backgroundColor: 'rgba(200,146,42,0.06)', borderColor: 'rgba(200,146,42,0.2)' },
  ...
  bigValue: { fontSize: 40, lineHeight: 44, color: '#F0E8D5', fontFamily: 'Manrope_700Bold', letterSpacing: -1.2 },
  statRow: { flexDirection: 'row', marginTop: 20, paddingTop: 20, borderTopWidth: 1, borderTopColor: 'rgba(240,232,213,0.07)', gap: 16 },
  statCol: { flex: 1 },
  statValue: { fontSize: 16, lineHeight: 24, color: '#F0E8D5', fontFamily: 'Manrope_700Bold', marginTop: 2 },
  statLabel: { fontSize: 12, lineHeight: 18, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular' },
  sectionLabel: {
    fontSize: 12,
    lineHeight: 18,
    color: 'rgba(240,232,213,0.45)',
  ...
  sectionLabelInline: { fontSize: 15, lineHeight: 22, color: '#F0E8D5', fontFamily: 'Manrope_700Bold' },
  link: { fontSize: 14, lineHeight: 21, color: '#C8922A', fontFamily: 'Manrope_600SemiBold' },
  ...
  barAmount: { fontSize: 16, lineHeight: 24, color: '#F0E8D5', fontFamily: 'Manrope_700Bold' },
  barTrack: { height: 6, borderRadius: 999, backgroundColor: 'rgba(240,232,213,0.05)', overflow: 'hidden' },
  barFill: { height: 6, borderRadius: 999, backgroundColor: '#C8922A' },
  svcName: { fontSize: 14, lineHeight: 21, color: '#F0E8D5', fontFamily: 'Manrope_700Bold' },
  svcMeta: { fontSize: 12, lineHeight: 18, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular', marginTop: 2 },
  clientRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 16, borderTopWidth: 1, borderTopColor: 'rgba(240,232,213,0.07)' },
  avatar: {
    width: 40,
    height: 40,
    borderRadius: 20,
  ...
  flex1: { flex: 1 },
  clientName: { fontSize: 15, lineHeight: 22, color: '#F0E8D5', fontFamily: 'Manrope_700Bold' },
  clientMeta: { fontSize: 12, lineHeight: 18, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular', marginTop: 2 },
  ltv: { fontSize: 14, lineHeight: 21, color: '#F0E8D5', fontFamily: 'Manrope_700Bold' },
  combined: {
    fontSize: 12,
    lineHeight: 18,
    color: 'rgba(240,232,213,0.45)',
  ...
  riskValue: { fontSize: 20, lineHeight: 25, color: '#F0E8D5', fontFamily: 'Manrope_700Bold', marginTop: 8 },
  riskSub: { fontSize: 15, lineHeight: 22, color: 'rgba(240,232,213,0.45)', fontFamily: 'Manrope_400Regular', marginTop: 6 },
  riskBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 14 },
  riskBtnText: { fontSize: 14, lineHeight: 21, color: '#C8922A', fontFamily: 'Manrope_700Bold' },
  deltaUp: { fontSize: 12, lineHeight: 18, color: '#4CAF50', fontFamily: 'Manrope_700Bold' },
  deltaDown: { fontSize: 12, lineHeight: 18, color: '#E05C5C', fontFamily: 'Manrope_700Bold' },
})
