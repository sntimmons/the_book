...
const NAV_SECTIONS = [
  {
    label: 'BUSINESS',
    items: [
      { icon: 'home',        label: 'Dashboard',   route: '/(tabs)/business',              badge: null },
      { icon: 'calendar',    label: 'Bookings',     route: '/(tabs)/business/bookings',     badge: null },
      { icon: 'clock',       label: 'Availability', route: '/(tabs)/business/availability', badge: null },
      { icon: 'file-text',   label: 'Policies',     route: '/(tabs)/business/policies',     badge: null },
      { icon: 'users',       label: 'My Clients',   route: '/(tabs)/business/clients',      badge: null },
      ...
      { icon: 'bar-chart-2', label: 'Analytics',    route: '/(tabs)/business/analytics',    badge: null },
    ],
  },
  {
    label: 'CONTENT',
    items: [
      { icon: 'image', label: 'Portfolio',   route: '/(tabs)/business/portfolio', badge: null },
      { icon: 'film',  label: 'Posts & Reels', route: '/(tabs)/business/posts',  badge: null },
    ],
  },
  {
    label: 'MONEY',
    items: [
      ...
      { icon: 'tag',         label: 'Services', route: '/(tabs)/business/services', badge: null },
    ],
  },
  {
    label: 'ACCOUNT',
    items: [
      { icon: 'user',        label: 'Edit Profile', route: '/(tabs)/business/edit-profile', badge: null },
      { icon: 'settings',    label: 'Settings',     route: '/(tabs)/business/settings',     badge: null },
          ...
          <View style={[styles.panelProfile, { paddingTop: insets.top + 16 }]}>
            ...
            <View style={styles.profileLinksRow}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
                onPress={() => handleNavItem('/(tabs)/business/edit-profile')}
              >
            ...
            {NAV_SECTIONS.map((section) => (
              <View key={section.label}>
                ...
                {section.items.map((item) => {
                  ...
                  const badge =
                    item.route === '/(tabs)/business/bookings'
                      ? pendingCount > 0
                        ? String(pendingCount)
                        : null
                      : item.badge
