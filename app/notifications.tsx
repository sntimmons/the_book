  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.body}>
        <Feather name="bell" size={36} color="rgba(240,232,213,0.1)" />
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardBody}>
            You will be notified when providers accept your bookings, send messages, or when you have upcoming appointments.
          </Text>
        </View>
      </View>
    </View>
